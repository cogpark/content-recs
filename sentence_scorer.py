...
"""
This file is a record of the original sentence scoring system. Not sure if we'll need this yet.
"""
...
if __name__ == "__main__":
    ...
    scorer.count_repeat_words("hello, hello, hello", print_reasons=True)